...
const Meta: FC<{
	...
	const metaTitle: string = title
		...
		: COMPANY_FULL_NAME;
	const metaDesc: string = COMPANY_FULL_NAME + ' | Створюємо затишні місця для відпочинку та постійного проживання. Насолоджуйтесь природою, комфортом і безпекою житла, де кожна деталь продумана для вашого задоволення та спокою.';
