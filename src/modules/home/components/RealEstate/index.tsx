...
const RealEstate = () => {
	...
	const engineeringCommunications = [
		'WATER_SUPPLY',
		'VEIN',
		'ACCESS_ROADS',
	]
	...
	return (
		<section className={s.container} id="realestate">
			<BlockTitle
			...
			<article className={s.inner}>
				<div className={s.info}>
					<h4
						className={s.infoTitle}>{t('REAL_ESTATE.COUNTRY_COMPLEX_FOR_RECREATION')}</h4>
					...
					<h5
						className={s.infoSubTitle}>{t('REAL_ESTATE.ENGINEERING_COMMUNICATIONS')}</h5>
